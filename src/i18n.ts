...
const dict: Record<string, Record<Language, string>> = {
	...
	"settings.location-key.name":               { en: "Location frontmatter key",      zh: "位置 frontmatter 键名" },
	"settings.location-key.desc":               { en: "Frontmatter property used to store GPS coordinates. Compatible with the official Maps plugin.", zh: "用于存储 GPS 坐标的 frontmatter 属性名。与官方 Maps 插件兼容。" },
	"settings.location-key.placeholder":        { en: "coordinates",                  zh: "coordinates" },
	"caption.placeholder":                   { en: "Add image description...",     zh: "添加图片描述..." },
	"location.gps-acquiring":                   { en: "Getting location…",            zh: "正在获取位置…" },
	"location.gps-error":                       { en: "GPS error: " ,                 zh: "GPS 错误：" },
	"location.gps-not-available":               { en: "Location services not available", zh: "位置服务不可用" },
	"location.placeholder":                       { en: "Location",                   zh: "位置" },
