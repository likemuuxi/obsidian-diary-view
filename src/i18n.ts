...
const dict: Record<string, Record<Language, string>> = {
	...
	"settings.custom-picker.heading":        { en: "Custom frontmatter pickers",   zh: "自定义 frontmatter 选择器" },
	"settings.custom-picker.desc":           { en: "Add custom frontmatter keys with selectable options. Each picker appears next to the mood trigger in the diary view.", zh: "添加自定义 frontmatter 键及其候选选项。每个选择器会显示在日记视图的心情设置旁边。" },
	...
	"custom-picker.set-placeholder":         { en: "Set",                          zh: "设置" },
