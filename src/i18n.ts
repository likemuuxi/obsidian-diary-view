...
const dict: Record<string, Record<Language, string>> = {
	...
	"settings.weather-lang.name":            { en: "Weather language",             zh: "天气显示语言" },
	"settings.weather-lang.desc":            { en: "Display language for the weather picker menu.", zh: "天气选择菜单的显示语言" },
	...
	"settings.mood-lang.name":               { en: "Mood language",                zh: "心情显示语言" },
	"settings.mood-lang.desc":               { en: "Display language for built-in mood descriptions.", zh: "内置心情描述的显示语言" },
